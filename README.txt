...
a persistence unit "HolaMundoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "HolaMundo/pom.xml":
...
artifact ("HolaMundo.war") is already built. You can build
